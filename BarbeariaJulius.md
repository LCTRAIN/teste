...
Comentários:
7. O cliente acessa o sistema usando suas credenciais de login.
8. O cliente é direcionado para o painel onde seus agendamentos passados são exibidos.
9. O cliente localiza o agendamento sobre o qual deseja comentar.
10. Junto ao agendamento concluído, o cliente encontra a opção "Comentar" e clica nela.
11. O sistema exibe um campo de texto onde o cliente pode escrever seu comentário.
